...
//       <defs>
//         <pattern id="azulejo" x="0" y="0" width="56" height="56" patternUnits="userSpaceOnUse">
//           <rect x="1" y="1" width="25" height="25" fill="none" stroke="#C9A84C" strokeWidth="0.8"/>
//           <rect x="30" y="1" width="25" height="25" fill="none" stroke="#C9A84C" strokeWidth="0.8"/>
//           <rect x="1" y="30" width="25" height="25" fill="none" stroke="#C9A84C" strokeWidth="0.8"/>
//           <rect x="30" y="30" width="25" height="25" fill="none" stroke="#C9A84C" strokeWidth="0.8"/>
//           <circle cx="28" cy="28" r="1.8" fill="#C9A84C"/>
//           <line x1="13" y1="1" x2="13" y2="26" stroke="#C9A84C" strokeWidth="0.4" opacity="0.5"/>
//           <line x1="1" y1="13" x2="26" y2="13" stroke="#C9A84C" strokeWidth="0.4" opacity="0.5"/>
//         </pattern>
//       </defs>
...
//         }
//         @media (max-width: 860px) { .suc-grid { grid-template-columns: 1fr 1fr; } }
//         @media (max-width: 540px) { .suc-grid { grid-template-columns: 1fr; } }
...
//       <section className="suc-section" style={{ position:"relative", background:"#0F1C2E", padding:"4.5rem 1.5rem 3.5rem", overflow:"hidden" }}>
//         <TilePattern />
//         <div style={{ position:"absolute",top:"-90px",left:"50%",transform:"translateX(-50%)",width:"700px",height:"280px",background:"radial-gradient(ellipse,rgba(201,168,76,.07) 0%,transparent 70%)",pointerEvents:"none" }}/>

//         <div style={{ maxWidth:"1100px", margin:"0 auto", position:"relative" }}>

//           {/* Header */}
//           <div style={{ textAlign:"center", marginBottom:"2.5rem", animation:"suc-fadeIn .7s ease both" }}>
//             <span style={{ display:"inline-block", fontSize:"20px", fontWeight:700, letterSpacing:"0.22em", textTransform:"uppercase", color:"#C9A84C", marginBottom:"0.75rem" }}>
//               ── Visítanos ──
//             </span>
//             <h2 style={{ fontFamily:"'Playfair Display',Georgia,serif", fontSize:"clamp(1.9rem,4vw,2.6rem)", fontWeight:700, color:"#FFF", margin:"0 0 .6rem", lineHeight:1.15 }}>
//               Nuestras Sucursales
//             </h2>
//             <p style={{ fontSize:".88rem", color:"rgba(255,255,255,.42)", maxWidth:"460px", margin:"0 auto", lineHeight:1.75, fontWeight:300 }}>
//               Selecciona una sucursal para ver su ubicación en el mapa. Material de entrega inmediata y servicio a domicilio.
//             </p>
//             <p style={{ fontSize:".88rem", color:"rgb(255,255,255)", maxWidth:"460px", margin:"0 auto", lineHeight:1.75, fontWeight:300 }}>
              
//               Whatsapp Business 
//                                     <a className="suc-tel" href={`tel:+52 312 190 7380`} onClick={e => e.stopPropagation()}>{'+52 312 190 7380'}</a>
...
//                   <span style={{ fontSize:"9px", fontWeight:700, letterSpacing:".16em", textTransform:"uppercase", color:"#C9A84C", background:"rgba(201,168,76,.12)", padding:"3px 9px", border:"1px solid rgba(201,168,76,.25)", borderRadius:"1px" }}>
//                     {suc.tipo}
//                   </span>
...
//                   <div>
//                     {suc.telefonos.map(t => (
//                       <a key={t} className="suc-tel" href={`tel:${t.replace(/\s|\(|\)|-/g,"")}`} onClick={e => e.stopPropagation()}>{t}</a>
//                     ))}
//                   </div>
//                 </div>

//                 <p style={{ margin:".8rem 0 0", fontSize:".67rem", letterSpacing:".09em", textTransform:"uppercase", fontWeight:700, color: selected === i ? "#C9A84C" : "rgba(201,168,76,.35)", transition:"color .3s" }}>
...
//             {sucursales.map((_, i) => (
//               <button key={i} className={`suc-dot${selected === i ? " suc-dot-active" : ""}`} onClick={() => setSelected(i)} aria-label={`Ver sucursal ${i+1}`}/>
//             ))}
//           </div>

//           {/* Map — key forces iframe remount on branch change */}
...
//                 </span>
//               </div>
//               <a className="suc-map-cta" href={`https://maps.google.com/?q=${s.mapQuery}`} target="_blank" rel="noopener noreferrer">
//                 Abrir en Google Maps <Arrow/>
//               </a>
//             </div>
//           </div>

//           <p style={{ textAlign:"center", marginTop:"1.75rem", fontSize:".74rem", color:"rgba(255,255,255,.22)", letterSpacing:".05em" }}>
...
function TilePattern() {
  return (
    <svg
      style={{ position:"absolute", inset:0, width:"100%", height:"100%", opacity:.06, pointerEvents:"none" }}
