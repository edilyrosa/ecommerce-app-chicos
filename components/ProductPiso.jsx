...
export default function ProductPiso({ producto }) {
  ...
  // Determinar si hay descuento positivo
  const tieneDescuento = producto.precio_anterior && producto.precio_anterior > producto.precio
  ...
  return (
    ...
    >
      ...
      <div className='relative h-72 md:h-80 overflow-hidden bg-gray-50'>
        ...
        {/* Badge de descuento - estilo amarillo */}
        {tieneDescuento && (
          <div className='absolute top-4 left-4 z-20 bg-yellow-400 text-gray-900 font-black text-[11px] md:text-sm px-2 py-0.5 md:py-1 rounded-full shadow-md'>
            {descuento}%
          </div>
        )}
