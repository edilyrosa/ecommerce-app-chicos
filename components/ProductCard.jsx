...
//     const [showImageModal, setShowImageModal] = useState(false) // Estado para el modal de imagen
...
//         >
//             {/* Botón cerrar - Solo visible cuando está en zoom (modo card) */}
//             {isZoomed && (
//                 <button
//                     onClick={(e) => {
//                         e.stopPropagation();
...
//                                         className='w-full h-full object-contain mx-auto group-hover:scale-110 transition-transform duration-300 cursor-zoom-in'
//                                         loading="lazy"
//                                         onClick={(e) => {
//                                             e.stopPropagation();
...
//             {/* Modal de imagen (fuera del flujo, fijo) */}
//             {showImageModal && (
//                 <div 
//                     className="fixed inset-0 z-[200] flex items-center justify-center p-4 bg-black/90"
//                     onClick={() => setShowImageModal(false)}
//                 >
//                     {/* Botón de cierre: círculo amarillo con X azul, fuera de la imagen */}
//                     <button
//                         onClick={(e) => {
//                             e.stopPropagation();
//                             setShowImageModal(false);
//                         }}
//                         className="absolute top-4 right-4 z-10 bg-yellow-400 hover:bg-yellow-500 text-blue-600 rounded-full p-3 shadow-xl transition-all duration-200 hover:scale-110"
//                         aria-label="Cerrar"
//                     >
//                         <X size={24} strokeWidth={2.5} />
//                     </button>

//                     {/* Imagen centrada, sin scroll */}
//                     <img
//                         src={imagenes[currentImageIndex]}
//                         alt={`${producto.nombre} - ampliada`}
//                         className="max-w-[100%] max-h-[100%] object-contain cursor-pointer"
...
import { Plus, Truck, ChevronLeft, ChevronRight, X } from 'lucide-react';
import { useState, useEffect } from 'react';
import { formatPrice } from '@/lib/formatPrice'; // ← importar función de formato
