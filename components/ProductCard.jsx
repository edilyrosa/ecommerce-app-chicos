...
//                                 <button
//                                     onClick={prevImage}
//                                     className='absolute left-1 top-1/2 -translate-y-1/2 bg-transparen hover:bg-yellow-500 md:p-1 rounded-full shadow-lg transition'
//                                 >
...
//                     <div 
//                         className="text-justify text-[9px] md:text-xs text-gray-500 pr-1 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent"
//                         style={{
//                             maxHeight: '80px',
//                             scrollbarWidth: 'thin',
...
//                     <p className="leading-tight text-[9px] md:text-xs text-gray-500">
//                         {textoTruncado}
...
//                                 <button
//                                     onClick={toggleDescripcion}
//                                     className="text-blue-600 hover:text-blue-800 font-medium inline focus:outline-none"
//                                 >
//                                     ver más
//                                 </button>
//                             </>
...
//                 <h3 className='text-[11px] md:text-sm font-bold text-gray-800 line-clamp-2'>
//                     {producto.nombre}
//                 </h3>
