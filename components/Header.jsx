...
'use client'
import { Edit2, Home, Save, Grid, ShoppingCart, User, ShoppingBag, 
    ChevronDown, LayoutGrid, Search, LogOut, Tag, MessageCircle, Settings } from 'lucide-react'
                                ...
                                <div className='relative'>
                                    ...
                                    {showAdminMenu && (
                                        <div className='absolute right-0 mt-2 w-40 bg-[#00162f] border shadow-2xl rounded-2xl p-2 z-60 animate-in fade-in'>
                                            <div className='flex flex-col gap-1'>
                                                <Link href='/crud-pedidos' className="block text-left py-1.5 px-3 rounded-xl text-xs font-semibold text-white hover:bg-yellow-400 hover:text-blue-900 transition-all">
                                                    <Edit2 size={16} />
                                                    CRUD Pedidos
                                                </Link>
                                                ...
                                                <Link href='/crud-banners' className="block text-left py-1.5 px-3 rounded-xl text-xs font-semibold text-white hover:bg-yellow-400 hover:text-blue-900 transition-all">
                                                    <Edit2 size={16} />
                                                    CRUD Banners
                                                </Link>
                                            </div>
                        ...
                        <div className='hidden md:flex items-center gap-2'>
                            {user ? (
                                <>
                                    ...
                                    {/* Menú de administrador agrupado (desktop) */}
                                    {isAdmin && (
                                        <div className='relative'>
                                            <button 
                                                onClick={() => setShowAdminMenu(!showAdminMenu)}
                                                className={`flex flex-col items-center justify-center gap-0.5 md:gap-1 px-1.5 md:px-2 py-1 md:py-1.5 rounded-xl transition-all duration-200 min-w-[50px] md:min-w-[60px] ${
                                                    showAdminMenu ? 'bg-white text-blue-900 shadow-lg font-bold' : 'bg-transparent text-white hover:bg-white/10'
                                                }`}
                                            >
                                                <Settings size={18} />
                                            ...
                                            {showAdminMenu && (
                                                <div className='absolute right-0 mt-2 w-[15vw] bg-[#00162f] border shadow-2xl rounded-2xl p-2 z-60 animate-in fade-in'>
                                                    <div className='flex flex-col gap-1'>
                                                        <Link href='/crud-pedidos' className="block text-left py-1.5 px-3 rounded-xl text-xs font-semibold text-white hover:bg-yellow-400 hover:text-blue-900 transition-all">
                                                            <Edit2 size={16} />
                                                            CRUD Pedidos
