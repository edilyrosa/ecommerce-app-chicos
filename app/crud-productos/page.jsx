...
// //   // Para previsualización de imágenes seleccionadas
...
// //   // Manejar selección de archivos y crear URLs de previsualización
...
// //   // Limpiar URLs de previsualización cuando los archivos cambian o el componente se desmonta
// //   useEffect(() => {
// //     return () => {
...
// //       await fetchStorageUsage(); // actualizar uso después de cambios
// //       limpiarFormulario();
// //     } catch (error) {
// //       console.error('Error:', error);
// //       toast.error(error.message);
...
// //       await fetchProductos();
// //       await fetchStorageUsage(); // actualizar uso después de eliminar
// //     } catch (error) {
// //       console.error('Error:', error);
...
// //                   <div>
// //                     <label className="block text-sm font-bold mb-2">
// //                       Pegamento Sugerido {esObligatorio('pegamento_sugerido') && <span className="text-red-500">*</span>}
// //                     </label>
// //                     <input
// //                       type="text"
...
// //                   <div>
// //                     <label className="block text-sm font-bold mb-2">
// //                       Junteador Sugerido {esObligatorio('junteador_sugerido') && <span className="text-red-500">*</span>}
// //                     </label>
// //                     <input
// //                       type="text"
...
// //                   {/* Subida de archivos + previsualización */}
// //                   <div className="md:col-span-2">
// //                     <label className="block text-sm font-bold mb-2">
// //                       Subir imágenes (múltiples, opcional), 
// //                     </label>
// //                     <label className="block text-sm mb-2">
// //                       ➕Si deseas subir +1 imagen, despues de crear este producto modificalo agregandole mas imagenes.
// //                     </label>
// //                     <input
// //                       type="file"
// //                       accept="image/*"
...
// //                           Restante: {storageUsage.remainingMB} MB
// //                         </p>
// //                       </div>
// //                     )}
// //                   </div>
...
// //                 <button
// //                   type="submit"
// //                   disabled={guardando || uploadingImages}
...
// //         {/* Tabla de productos con diseño responsivo */}
// //         <div className="bg-white rounded-2xl shadow-xl overflow-x-auto">
// //           <div className="inline-block min-w-full align-middle">
// //             <table className="min-w-full divide-y divide-gray-200">
// //               <thead>
// //                 <tr style={{ backgroundColor: '#00162f' }}>
// //                   <th className="px-3 py-3 text-left text-xs font-bold text-white uppercase whitespace-nowrap">Imagen</th>
// //                   <th className="px-3 py-3 text-left text-xs font-bold text-white uppercase whitespace-nowrap">Código</th>
// //                   <th className="px-3 py-3 text-left text-xs font-bold text-white uppercase whitespace-nowrap">Nombre</th>
// //                   <th className="px-3 py-3 text-center text-xs font-bold text-white uppercase whitespace-nowrap">Stock</th>
// //                   <th className="px-3 py-3 text-right text-xs font-bold text-white uppercase whitespace-nowrap">Precio</th>
// //                   <th className="px-3 py-3 text-right text-xs font-bold text-white uppercase whitespace-nowrap">Precio Ant.</th>
// //                   <th className="px-3 py-3 text-center text-xs font-bold text-white uppercase whitespace-nowrap">Acciones</th>
// //                 </tr>
// //               </thead>
...
// //                         <p className="font-bold text-sm md:text-base line-clamp-2" style={{ color: '#00162f' }}>
// //                           {producto.nombre}
// //                         </p>
// //                         {producto.linea && (
...
// //                       }`}>
// //                         <Package size={12} className="hidden sm:inline" />
// //                         {producto.stock}
// //                       </span>
// //                     </td>
// //                     <td className="px-3 py-3 text-right whitespace-nowrap">
// //                       <span className="font-bold text-sm md:text-base" style={{ color: '#00162f' }}>
...
// //                           className="p-1.5 md:p-2 hover:bg-blue-100 rounded-lg transition group"
// //                           title="Editar"
// //                         >
// //                           <Edit2 size={16} className="text-blue-600 group-hover:scale-110 transition" />
// //                         </button>
// //                         <button
// //                           onClick={() => handleEliminar(producto.id)}
// //                           disabled={eliminando === producto.id}
// //                           className="p-1.5 md:p-2 hover:bg-red-100 rounded-lg transition group disabled:opacity-50"
// //                           title="Eliminar"
// //                         >
// //                           {eliminando === producto.id ? (
// //                             <Loader2 size={16} className="text-red-600 animate-spin" />
// //                           ) : (
// //                             <Trash2 size={16} className="text-red-600 group-hover:scale-110 transition" />
// //                           )}
// //                         </button>
// //                       </div>
// //                     </td>
...
//         {modoEdicion && (
//           <div className="bg-white rounded-2xl shadow-xl p-6 border-2" style={{ borderColor: '#fbbf24' }}>
//             <div className="flex items-center justify-between mb-6">
//               <h2 className="text-xl font-black" style={{ color: '#00162f' }}>
//                 {productoEditando ? 'Editar Producto' : 'Nuevo Producto'}
//               </h2>
...
//                   <th className="px-2 py-2 md:px-3 md:py-3 text-right text-[11px] md:text-xs font-bold text-white uppercase whitespace-nowrap">Precio</th>
//                   <th className="px-2 py-2 md:px-3 md:py-3 text-right text-[11px] md:text-xs font-bold text-white uppercase whitespace-nowrap">Precio Ant.</th>
...
//                       </span>
//                     </td>
//                     <td className="px-2 py-2 md:px-3 md:py-3 text-right whitespace-nowrap">
...
//                           title="Editar"
//                         >
//                           <Edit2 size={14} className="text-blue-600 group-hover:scale-110 transition" />
//                         </button>
//                         <button
//                           onClick={() => handleEliminar(producto.id)}
//                           disabled={eliminando === producto.id}
...
//                           ) : (
//                             <Trash2 size={14} className="text-red-600 group-hover:scale-110 transition" />
//                           )}
//                         </button>
//                       </div>
//                     </td>
    ...
    <div className="min-h-screen bg-gray-50 pb-8">
      ...
      <main className="container mx-auto px-3 md:px-6 py-6 max-w-7xl">
        ...
        <div className="flex items-center justify-center gap-4 mb-6">
          ...
          {/* //* Formulario de creación/edición */}
          {modoEdicion && (
            <div className="w-[95%] rounded-2xl shadow-xl my-4 p-6 border-2" style={{ borderColor: '#fbbf24' }}>
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-black" style={{ color: '#00162f' }}>
                  {productoEditando ? 'Editar Producto' : 'Nuevo Producto'}
                </h2>
        ...
        {/* //* Tabla de productos (siempre visible) */}
        <div className="w-[95%] bg-white rounded-2xl shadow-xl overflow-x-auto my-4">
          <div className="inline-block min-w-full align-middle">
            <table className="min-w-full divide-y divide-gray-200">
              <thead>
                <tr style={{ backgroundColor: '#00162f' }}>
