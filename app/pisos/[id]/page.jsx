...
import { 
  ...
  Calculator, MessageCircle, Package, AlertTriangle
} from 'lucide-react'
...
export default function PisoDetailPage() {
  ...
  const calcularDecoradosLineales = () => {
    ...
    const anchoPiezaCm = parseFloat(match[2])
    ...
    const altoPiezaCm = parseFloat(match[1])
      ...
      <main className='w-full mx-auto px-3 md:px-6 py-4 md:py-6 max-w-[1400px]'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-6 md:gap-8 lg:gap-6 mb-8'>
          ...
          <div className="space-y-3 lg:space-y-3 max-w-full overflow-hidden">
            ...
            {/* Atributos rápidos para pisos/azulejos */}
            ...
            {esDecoradoLineal ? (
              <div className='rounded-xl p-3 lg:p-4 border-2 overflow-hidden' style={{ backgroundColor: '#00162f', borderColor: '#00162f' }}>
                ...
                {/* Complementos para decorados lineales */}
                {areaDecoradoTotal && (
