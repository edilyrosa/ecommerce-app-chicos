...
function Tienda() {
  ...
  const handleProductClick = (productId) => setZoomedProductId(productId)
  const handleCloseZoom    = ()           => setZoomedProductId(null)
    ...
    <div className="min-h-screen bg-gray-50 pb-20 md:pb-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 md:gap-4">
            {[...Array(6)].map((_, i) => (
              <div key={i} className="bg-white rounded-lg shadow-sm p-4 animate-pulse">
                <div className="bg-gray-200 h-40 md:h-48 rounded-lg mb-3" />
                <div className="bg-yellow-100 h-4 rounded mb-2" />
                <div className="flex justify-between items-center gap-2">
                  <div className="w-[70%] flex-1 bg-gray-200 h-10 rounded" />
      ...
      <style jsx global>{`
        ...
        @media(min-width:768px) {
          .products-grid-zoom .product-card-zoom.zoomed { max-width: 45vw; }
        }
        ...
        .products-grid-zoom .product-card-zoom.zoomed .product-image-container { flex-shrink: 0; }
...
// ── Wrapper con Suspense (requerido por useSearchParams en Next 13+) ──
